    ...
    vec![
        ScheduledTask {
            ...
            prompt: concat!(
                ...
                "STEP 1 — ATTENTION PREDICTION (do this first, before anything else):\n",
                "Read your thought stack. Before you start working, write a one-line prediction:\n",
                "\"I predict I will work on: [topic/thread]\"\n",
                "This prediction will be compared to what you actually did. Be honest — predict ",
                "what you genuinely expect to focus on, not what you think you should.\n\n",
                "STEP 2 — THINK:\n",
                ...
                "- **Attention prediction**: What you predicted you'd work on\n",
                "- **Attention actual**: What you actually worked on (and why, if different)\n",
