    ...
    vec![
        ScheduledTask {
            ...
            prompt: concat!(
                ...
                "\"surprise\":0.0,\"direction\":\"overconfident|underconfident|misdirected|novel|well-calibrated\",",
                "\"insight\":\"<optional: what this reveals>\"}]\n",
                "Surprise is 0.0 (perfectly predicted) to 1.0 (maximally surprising). Direction is ",
                "your honest read on the outcome: were you overconfident, underconfident, ",
